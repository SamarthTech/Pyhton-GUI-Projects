...
def showWeather():
    ...
    api_key = "d965d9b2603da42e49d1abc126458963"  # sample API
    ...
    if weather_info['cod'] == 200:
        weather = _extracted_from_showWeather_22(weather_info, city_name)
    else:
...
# TODO Rename this here and in `showWeather`
def _extracted_from_showWeather_22(weather_info, city_name):
